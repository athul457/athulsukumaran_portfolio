        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mt-12">
          <div className="card p-8 bg-white dark:bg-dark-900 h-full flex flex-col">
            ...
            <p className="text-dark-600 dark:text-dark-300 mb-4">
              ...
              performance-optimized applications with clean, maintainable code.
            </p>
            <p className="text-dark-600 dark:text-dark-300 mb-4">
              My approach to development combines technical excellence with a
              user-centered focus, ensuring applications that are not only
              technically sound but also intuitive and enjoyable to use.
            </p>
            <p className="text-dark-600 dark:text-dark-300">
              I thrive in collaborative environments and continuously expand my
              skills to stay at the forefront of web development trends, with
              particular interest in AI-integrated development, serverless
              computing, and progressive web apps.
            </p>

            <div className="mt-8">
              <h4 className="text-lg font-semibold mb-3 text-dark-900 dark:text-white">
                Languages
              </h4>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
            ...
            <div className="card p-6 flex flex-col items-center text-center transform transition-all duration-300 hover:scale-105 hover:bg-blue-950">
              ...
              <p className="text-dark-600 dark:text-dark-400 text-sm">
                Designing and optimizing databases with SQL and NoSQL
                technologies.
              </p>
            </div>
            ...
            <div className="card p-6 flex flex-col items-center text-center transform transition-all duration-300 hover:scale-105 hover:bg-blue-950">
              ...
              <p className="text-dark-600 dark:text-dark-400 text-sm">
                Writing maintainable, well-structured code following best
