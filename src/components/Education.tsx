        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 mt-12">
            ...
            <div className="ml-4">
              <div className="timeline-item">
                <div className="mb-6">
                  ...
                  <p className="text-dark-600 dark:text-dark-300 mt-3">
                    Completed my Master of Computer Applications (MCA) in 2025
                    with a focus on modern software development methodologies
                    and practices
                  </p>
                </div>
              </div>
              ...
              <div className="timeline-item">
                <div>
                  ...
                  <p className="text-dark-600 dark:text-dark-300 mt-3">
                    Completed a comprehensive program in computer science,
                    covering programming fundamentals, data structures,
                    algorithms, database systems, and software engineering
                    principles.
                  </p>
                </div>
              </div>
          ...
          <div>
            <div className="flex items-center mb-8">
              <Award
                size={28}
                className="text-secondary-600 dark:text-secondary-400 mr-3"
              />
              <h3 className="text-2xl font-bold text-dark-800 dark:text-white">
                Certifications
              </h3>
            ...
            <div className="card p-6 bg-white dark:bg-dark-900 border-l-4 border-secondary-500 dark:border-secondary-600 hover:shadow-xl transition-shadow duration-300">
              ...
              <p className="text-dark-600 dark:text-dark-300 mt-4">
                Comprehensive training in cloud computing concepts,
                architectures, service models, virtualization, security, and
                deployment strategies. The certification involved practical
                assignments and a final examination to demonstrate proficiency.
              </p>
            </div>
            ...
            <div className="mt-8">
              ...
              <p className="text-dark-600 dark:text-dark-300">
                In addition to formal education and certifications, I regularly
                participate in online courses, workshops, and coding challenges
                to enhance my skills and stay current with industry trends and
                best practices.
              </p>
